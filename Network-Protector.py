...
def predict_group_or_sw(mainwindow, tech_list):
    ...
    for tech_name in tech_list:
        group_or_sw_list = []
        if 'Examples' in mainwindow.techniques['Enterprise'][tech_name]:
...
def change_interface(mainwindow, event_set, event_id, evt_local_time, tac_tech_list):
    ...
    for elem in tac_list:
        ...
        mainwindow.tac_tech_events[elem]['Button'].setStyleSheet(mainwindow.detect_tac_button_style)
                    ...
                    if evt_id == 5:
                        ...
                        if 'powershell.exe' == image_exe:
                            ...
                            if ps_dict != {}:
                                ...
                                change_interface(self.mainwindow, event_set, ps_dict['ps_start']['Event']['System']['EventRecordID'], evt_local_time, tac_tech_list)
                                ...
                                if ps_dict['mimikatz'] == 1:
                                    ...
                                    if com_check[0] == True:
                                        ...
                                        for elem in all_tac_list:
                                            append_to_event_dict(self.mainwindow.tac_tech_events[elem]['Events'], ps_dict['ps_start']['Event']['System']['EventRecordID'], event_set)
                                            add_table_row(self.mainwindow.tac_tech_events[elem]['Table'], evt_local_time, ps_dict['ps_start']['Event']['System']['EventRecordID'], 'CAR-2013-04-002', 'Quick execution of a series of suspicious commands')
                                        ...
                                        for elem in all_tech_tac_list:
                                            ...
                                            append_to_event_dict(self.mainwindow.tac_tech_events[tmp_list[1]][tmp_list[0]]['Events'], ps_dict['ps_start']['Event']['System']['EventRecordID'], event_set)
                                            add_table_row(self.mainwindow.tac_tech_events[tmp_list[1]][tmp_list[0]]['Table'], evt_local_time, ps_dict['ps_start']['Event']['System']['EventRecordID'], 'CAR-2013-04-002', 'Quick execution of a series of suspicious commands')
                                        ...
                                        # Home Detected Events
                                        append_to_event_dict(self.mainwindow.home_detected_events, ps_dict['ps_start']['Event']['System']['EventRecordID'], event_set)
                                        home_add_table_row(self.mainwindow, evt_local_time, ps_dict['ps_start']['Event']['System']['EventRecordID'], event_set)

                                        # Event History Table
                                        history_add_table_row(mainwindow, evt_local_time, ps_dict['ps_start']['Event']['System']['EventRecordID'], event_set)
